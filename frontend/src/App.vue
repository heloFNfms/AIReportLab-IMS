...
:root {
  ...
  --brand-gradient-mid: #00f2fe;
  --brand-gradient-end: #43e97b;
  ...
  --border-color-light: rgba(241, 245, 249, 0.8);
  ...
  --el-color-primary-dark-2: var(--brand-primary-dark);
